...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("CustomerOrdersObjectPageObjectPage journey");

        opaTest("Navigate to CustomerOrdersObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheCustomersObjectPage.onTable({ property: "orders" }).iCheckRows();
            When.onTheCustomersObjectPage.onTable({ property: "orders" }).iPressRow(0);

            Then.onTheCustomerOrdersObjectPage.iSeeThisPage();
        });
